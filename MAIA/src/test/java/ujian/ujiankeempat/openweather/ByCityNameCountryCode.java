...
public class ByCityNameCountryCode {
		...
		public void befTest() {
			...
			String excelPath = "C:\\Users\\NEXSOFT\\Documents\\lmsJuaraKoding\\Ujian\\Ujian_Keempat\\ByCityNameCountryCode.xlsx";
		...
		public void testGet(String idKota,String namaKota, String kodeNegara) {
			
			String apiKey = "169188bdd54dec8d21ed024fdac327ce";
			given().
				param("q",namaKota,kodeNegara).and().
				param("appid", apiKey).
