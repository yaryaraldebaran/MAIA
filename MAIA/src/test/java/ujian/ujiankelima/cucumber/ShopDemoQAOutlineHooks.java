...
import latihan.cucumber.framework.scenariotest.shopdemoqa.ShopDemoQAScene;
import latihan.cucumber.framework.utils.Utils;

public class ShopDemoQAOutlineHooks {
	public static WebDriver driver;
	public static ExtentTest extentTest;
	public static ExtentReports reports = new ExtentReports("target/dmqashop/extentreport/ShopDemoQAOutlineRunner.html");

@Before
public void setUp() {
	DriverSingleton.getInstance(Constants.CHROME);
	driver = DriverSingleton.getDriver();
	ShopDemoQAScene[] tests = ShopDemoQAScene.values();
